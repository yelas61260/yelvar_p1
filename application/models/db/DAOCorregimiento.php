...
class DAOCorregimiento extends CI_Model
{
	...
	public function getTablaVista(){
		return $this->lib->print_tabla([self::$tabla], ["ID", "Nombre"], self::$campos, self::$campos, null, ["edit", "delete"], ["edit", "delete"], ["accion/actualizarCorregimiento","DAOCorregimientoIMPL/delete_fun"]);
	}
